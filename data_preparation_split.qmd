...
ally_covar2 <- varDyadCovar(ally_list[9:16], warn = FALSE)
...
gdp_inv2<- gdp_inv[,9:16] %>% varCovar()


gdp_bil1 <- gdp_bil[,1:8] %>% varCovar()
gdp_bil2 <- gdp_bil[,9:16] %>% varCovar()

gdp_log1 <- gdp_log[,1:8] %>% varCovar()
gdp_log2 <- gdp_log[,9:16] %>% varCovar()
...
trade_log2 <- varDyadCovar(trade_list[9:16], warn = F)
...
trade_mil2 <- varDyadCovar(trade_list[9:16], warn = F)
